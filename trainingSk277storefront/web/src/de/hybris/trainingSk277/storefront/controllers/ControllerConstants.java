 ...
 */
package de.hybris.trainingSk277.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			{
				String singleData="pages/customPage/singleData";
						String listOfData="pages/customPage/listOfData";
						String pagination="pages/customPage/pagination";
						String form="pages/customPage/form";
						String update="pages/customPage/update";
			}
		}
