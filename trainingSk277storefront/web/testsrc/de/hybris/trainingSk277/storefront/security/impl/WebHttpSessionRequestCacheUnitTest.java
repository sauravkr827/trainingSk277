...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/trainingSk277storefront/electronics/en",
						"https://electronics.local:9002/trainingSk277storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/trainingSk277storefront/electronics/en",
						"https://electronics.local:9002/trainingSk277storefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/trainingSk277storefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/trainingSk277storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/trainingSk277storefront/electronics/en",
						"https://electronics.local:9002/trainingSk277storefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/trainingSk277storefront",
						"https://electronics.local:9002/trainingSk277storefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/trainingSk277storefront",
						"https://electronics.local:9002/trainingSk277storefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/trainingSk277storefront/electronics/en",
						"https://electronics.local:9002/trainingSk277storefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
