...
<div class="addtocart-component">
		...
		<div class="qty-selector input-group js-qty-selector">
			...
			<font color="#C70039" size="3px">IsNewProduct ::</font> <font color="#0B4BEB">${product.isNewProduct} </font>
		...
		<table>
			...
			<c:forEach items="${product.manufacturerDetails}" var="manuData">
				<tr>
					<td>${manuData.id}</td>
					<td>${manuData.name}</td>
					<td>${manuData.city}</td>
					<td>${manuData.country}</td>
				</tr>
			</c:forEach>
		</table>
