 ...
 */
package de.hybris.trainingSk277.test.setup;
...
import de.hybris.trainingSk277.test.constants.TrainingSk277TestConstants;
import de.hybris.trainingSk277.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TrainingSk277TestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/trainingSk277test/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/trainingSk277test/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/trainingSk277test/import/cstickets.impex");
			...
			importImpexFile(context, "/trainingSk277test/import/csquotes.impex");
		}
	}
}
