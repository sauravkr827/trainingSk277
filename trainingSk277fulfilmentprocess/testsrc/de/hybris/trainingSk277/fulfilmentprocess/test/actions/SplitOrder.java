 ...
 */
package de.hybris.trainingSk277.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TrainingSk277FulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TrainingSk277FulfilmentProcessConstants.PARENT_PROCESS);
